...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _libs_swiper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/swiper.js */ \"./src/js/libs/swiper.js\");\n/* harmony import */ var _libs_lightgallery_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./libs/lightgallery.min.js */ \"./src/js/libs/lightgallery.min.js\");\n/* harmony import */ var _default_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./default/header.js */ \"./src/js/default/header.js\");\n/* harmony import */ var _files_animation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./files/animation.js */ \"./src/js/files/animation.js\");\n/* harmony import */ var _files_tab_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./files/tab.js */ \"./src/js/files/tab.js\");\n/* harmony import */ var _files_spollers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./files/spollers.js */ \"./src/js/files/spollers.js\");\n/* harmony import */ var _files_popup_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./files/popup.js */ \"./src/js/files/popup.js\");\n/* harmony import */ var _files_hide_items_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./files/hide-items.js */ \"./src/js/files/hide-items.js\");\n/* harmony import */ var _files_map_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./files/map.js */ \"./src/js/files/map.js\");\n/* harmony import */ var _files_theme_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./files/theme.js */ \"./src/js/files/theme.js\");\n/* LIBS */\r\n/* CREATING SWIPERS */\r\n\r\n\r\n/* \r\n  GALLERY\r\n  how work: add attribute data-gallery - gallery wrap,\r\n  <a href=\"img-link\"></a> with and img in teg a :),\r\n  example in html\r\n*/\r\n\r\n\r\n/*----------*/\r\n/* DEFAULTS */\r\n\r\n\r\n/* FILES */\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n/*IN PROGRESS*/\r\n// import * as parallax from \"./files/paralax.js\";\r\n// import * as forms from \"./files/forms.js\";\r\n// parallax.init_paralax();\r\n// animation.lettersAnimation();\r\n\r\n\r\n_default_header_js__WEBPACK_IMPORTED_MODULE_2__.init_header();\r\n_files_tab_js__WEBPACK_IMPORTED_MODULE_4__.init_tabs();\r\n_files_spollers_js__WEBPACK_IMPORTED_MODULE_5__.init_spollers();\r\nif (document.getElementById(\"map\")) _files_map_js__WEBPACK_IMPORTED_MODULE_8__.init();\r\n_files_hide_items_js__WEBPACK_IMPORTED_MODULE_7__.init_hideItems();\r\n_files_popup_js__WEBPACK_IMPORTED_MODULE_6__.init_popup();\r\n_files_theme_js__WEBPACK_IMPORTED_MODULE_9__.theme_init();\r\n\r\n/* ANIMATION */ \r\n_files_animation_js__WEBPACK_IMPORTED_MODULE_3__.anim_on_scroll();\r\n_files_animation_js__WEBPACK_IMPORTED_MODULE_3__.animation_attribute();\r\n_files_animation_js__WEBPACK_IMPORTED_MODULE_3__.wave_text();\r\n_files_animation_js__WEBPACK_IMPORTED_MODULE_3__.typing_text();\r\n\r\n\r\nwindow.addEventListener(\"load\", function () {\r\n  if (document.querySelector('.wrapper')) {\r\n    setTimeout(function () {\r\n      document.querySelector('.wrapper').classList.add('_loaded');\r\n    }, 0);\r\n  }\r\n});\r\n\r\n/* Проверка поддержки webp, добавление класса webp или no-webp для HTML */\r\nfunction isWebp() {\r\n  // Проверка поддержки webp\r\n  function testWebP(callback) {\r\n    let webP = new Image();\r\n    webP.onload = webP.onerror = function () {\r\n      callback(webP.height == 2);\r\n    };\r\n    webP.src = \"data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA\";\r\n  }\r\n  // Добавление класса _webp или _no-webp для HTML\r\n  testWebP(function (support) {\r\n    let className = support === true ? 'webp' : 'no-webp';\r\n    document.documentElement.classList.add(className);\r\n  });\r\n}\r\n\r\nisWebp();\r\n\r\n/*\r\n  IBG \r\n  делает адаптивную картинку \r\n  Как работает: \r\n    берет все элементы с классом ibg,\r\n    дальше берет src картики в нутри ibg, \r\n    и делает backgroundImage для ibg.\r\n\r\n  И есть стили ibg.scss\r\n*/\r\n\r\nfunction ibg() {\r\n  let ibg = document.querySelectorAll(\".ibg\");\r\n  for (var i = 0; i < ibg.length; i++) {\r\n    if (ibg[i].querySelector('img')) {\r\n      ibg[i].style.backgroundImage = 'url(' + ibg[i].querySelector('img').getAttribute('src') + ')';\r\n    }\r\n  }\r\n}\r\n\r\nibg();\r\n\r\n\r\n/* CUSTOME SWITCH */\r\nconst switches = document.querySelectorAll('[data-switch]');\r\nswitches.forEach((item) => {\r\n  item.addEventListener('click', () => {\r\n    let text;\r\n    item.classList.toggle(\"_active\");\r\n    text = (item.classList.contains(\"_active\")) ? 'Светлая версия' : 'Темная версия'\r\n    item.querySelector('.switch__text').textContent = text;\r\n  });\r\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");

/***/ }),

/***/ "./src/js/default/header.js":
/*!**********************************!*\
  !*** ./src/js/default/header.js ***!
  \**********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"init_header\": () => (/* binding */ init_header)\n/* harmony export */ });\nfunction init_header() {\n  const isMobile = {\n    Android: function () {\n      return navigator.userAgent.match(/Android/i);\n    },\n    BlackBerry: function () {\n      return navigator.userAgent.match(/BlackBerry/i);\n    },\n    iOS: function () {\n      return navigator.userAgent.match(/iPhone|iPad|iPod/i);\n    },\n    Opera: function () {\n      return navigator.userAgent.match(/Opera Mini/i);\n    },\n    Windows: function () {\n      return (\n        navigator.userAgent.match(/IEMobile/i) ||\n        navigator.userAgent.match(/WPDesktop/i)\n      );\n    },\n    any: function () {\n      return (\n        isMobile.Android() ||\n        isMobile.BlackBerry() ||\n        isMobile.iOS() ||\n        isMobile.Opera() ||\n        isMobile.Windows()\n      );\n    },\n  };\n\n  if (isMobile.any()) {\n    document.body.classList.add(\"_touch\");\n\n    // .menu__sub-list \n    /* Выпадающий список */\n    let menuArrows = document.querySelectorAll(\".menu__arrow\");\n    if (menuArrows.length > 0) {\n      for (let index = 0; index < menuArrows.length; index++) {\n        const menuArrow = menuArrows[index];\n        menuArrow.addEventListener(\"click\", function (e) {\n          menuArrow.parentElement.classList.toggle(\"_active\");\n        });\n      }\n    }\n  } else {\n    document.body.classList.add(\"_pc\");\n  }\n\n  /* CLOSE MENU BURGER ELMENTS */ \n  const closeBurgerEls = document.querySelectorAll('[data-close-burger]');\n  closeBurgerEls.forEach((item) => {\n    item.addEventListener('click', () => {\n      iconMenu.classList.remove(\"_active\");\n      menuBody.classList.remove(\"_active\");\n      document.body.classList.remove(\"_lock\");\n    })\n  });\n\n  // SMOOTH SCROOLL\n  const menuLinks = document.querySelectorAll(\".menu__link[data-goto\");\n  if (menuLinks.length > 0) {\n    menuLinks.forEach((menuLink) => {\n      menuLink.addEventListener(\"click\", function (e) {\n        const menuLink = e.target;\n        if (\n          menuLink.dataset.goto &&\n          document.querySelector(menuLink.dataset.goto)\n        ) {\n          const gotoBlock = document.querySelector(menuLink.dataset.goto);\n          const gotoBlockValue =\n            gotoBlock.getBoundingClientRect().top +\n            pageYOffset -\n            document.querySelector(\"header\").offsetHeight - 20;\n          if (iconMenu.classList.contains(\"_active\")) {\n            iconMenu.classList.remove(\"_active\");\n            menuBody.classList.remove(\"_active\");\n            document.body.classList.remove(\"_lock\");\n          }\n          window.scrollTo({\n            top: gotoBlockValue,\n            behavior: \"smooth\",\n          });\n          e.preventDefault();\n        }\n      });\n    });\n  }\n\n  const iconMenu = document.querySelector(\".menu__icon\");\n  const menuBody = document.querySelector(\".menu__body\");\n  if (iconMenu) {\n    iconMenu.addEventListener(\"click\", function (e) {\n      iconMenu.classList.toggle(\"_active\");\n      menuBody.classList.toggle(\"_active\");\n      document.body.classList.toggle(\"_lock\");\n    });\n  }\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/default/header.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nlet myTextSlider = new Swiper(\".text-swiper\", {\n   navigation: {\n      nextEl: \".swiper-button-next\",\n      prevEl: \".swiper-button-prev\",\n   },\n   pagination: {\n      el: \".swiper-pagination\",\n      //clickable: true,\n      //dynamicBullets: true,\n      //renderBullet: function (index, className) {\n      //   return '<span class=\"' + className + '\">' + (index + 1) + \"</span>\";\n      //},\n      type: \"fraction\",\n      //type: \"progressbar\",\n   },\n   //Отвечает за свайпы\n   simulateTouch: true,\n   //Отвечает за чуствительность свайпа (с какой силой нужно перетаскивать)\n   touchRatio: 1,\n   //Угол свайпа\n   touchAngel: 45,\n   //Курсор перетаскивания\n   grabCursor: true,\n   //Переключение при клике на слайд\n   slideToClickSlide: true,\n\n   //Навигация по хешу\n   hashNavigation: {\n      watchState: true,\n   },\n\n   //Управление клавиатурой\n   keyboard: {\n      //Включить/выключить\n      enabled: true,\n      //Только когда слайдер виден\n      onlyInViewport: true,\n      //Разрешние для pageUp, pageDown\n      pageUpDown: true,\n   },\n\n   //Управление колесом мыши\n  //  mousewheel: {\n      //Чуствитиленомть мышки\n      // sensitivity: 1,\n      //Класс объекта на котором будет срабатывать\n      // eventsTarget: \".image-slider\",\n  //  },\n\n   autoHeight: false,\n\n   //Количество слайдов для показа(можно указывать не только целые числа)\n   //Если указать 'auto', то количество будет выбираться автоматически (лучше также указывать width:auto)\n   slidesPerView: 1,\n\n   //Отключает слайдер если слайдов меньше чем нужно\n   watchOverflow: true,\n\n   //Отступ между слайдами\n   //spaceBetween: -400,\n\n   //Количество пролистываемых слайдов\n   slidesPerGroup: 1,\n\n   //Активный слайд по центру\n   //centerSlides: true,\n\n   //Стартовый слайд (первый это нулевой)\n   initialSlide: 0,\n\n   //Мультиряды\n   //slidesPerColumn: 2,\n\n   //Бесконечный слайдер\n  //  loop: true,\n\n   //Количество дублирующих слайдов\n   //loopSlides: 1,\n\n   //Свободный режим (прокрутка на любое место)\n   freeMode: true,\n\n   //Автопрокрутка\n   //autoplay: {\n   //   //Пауза между прокрутами\n   //   delay: 1000,\n   //   //Закончить на последнем слайде\n   //stopOnLastSlide: false,\n   //   //Отключение после ручной прокрутки\n   //   disableOnInteraction: false,\n   //},\n\n   //Скорость прокрутки слайдов\n   speed: 400,\n\n   //Вертикальный слайдер\n   //direction: \"vertical\",\n\n   //Эффекты переключения слайдов\n   //Листание\n   effect: \"slide\",\n   //Смена прозрачности\n   //effect: \"fade\",\n\n   //// Дополнения к fade\n   //fadeEffect: {\n   //   //Паралельная смена прозрачности\n   //   crossFade: true,\n   //},\n\n   //Переворот\n   //effect: \"flip\",\n\n   //flipEffect: {\n   //   //Тень\n   //   slideShadows: true,\n   //   //Показ только активного слайда\n   //   limitRotation: true,\n   //},\n\n   //Кубик\n   //effect: \"cube\",\n\n   //cubeEffects: {\n   //   slideShadows: true,\n   //   shadow: true,\n   //   shadowOffset: 20,\n   //   shadowScale: 0.94,\n   //},\n\n   //Поток\n   //effect: \"coverflow\",\n\n   //coverflowEffect: {\n   //   //Угол\n   //   rotate: 20,\n   //   //Наложение\n   //   stretch: 50,\n   //   //Тень\n   //   slideShadows: true,\n   //},\n   //Брейкпоинты\n   //Есть возможность указывать и соотненшение сторон вместо ьрейкпоинтов в виде \"@0.75\"\n   //breakpoints: {\n   //   320: {\n   //      slidesPerView: 1,\n   //   },\n   //   767: {\n   //      slidesPerView: 1.5,\n   //   },\n   //   1300: {\n   //      slidesPerView: 2,\n   //   },\n   //},\n\n   //Lazy loading\n   //\n   //preloadImages: false,\n\n   //lazy: {\n   //   //Подгрузка на старте\n   //   loadTransitionStart: false,\n   //   //Подгрузка предыдущей и следующей картинки\n   //   loadPrevNext: false,\n   //},\n   ////--------------------------------\n   ////Стоит включать если показ более одного слайда\n   ////Слежка за видимыми слайдами\n   //watchSlidesProgress: true,\n   ////Добавления класса видимыми слайдами\n   //WatchSlidesVisibility: true,\n\n  //  zoom: {\n      //Максимальное и минимальное увеличение\n  //     maxRatio: 5,\n  //     minRatio: 1,\n  //  },\n\n   //Мини-слайдер\n  //  thumbs: {\n  //     swiper: {\n  //        el: \".image-mini-slider\",\n  //        slidesPerView: 4,\n  //     },\n  //  },\n\n   // Обновить свайпер\n   // при изменении элементов слайдера\n   observer: true,\n \n   // Обновить свайпер\n   // при изменении родительских\n   // элементов слайдера\n   observeParents: true,\n\n   // Обновить свайпер\n   // при изменении дочерних\n   // элементов слайда\n   observeSlideChildren: true,\n\n   //Виртуальные слайды\n   //virtual: {\n   //\tslides: (function () {\n   //\t\tlet slide = []\n   //\t\tfor (let i = 0; i < 500; i++) {\n   //\t\t\tslide.push(`<div class=\"image-slider__text\">Слайд №${i}</div>`);\n   //\t\t}\n   //\t\treturn slide;\n   //\t}()),\n   //},\n\n   // Доступность\n   //a11y: {\n   // Включить/выключить\n   //\tenabled: true,\n   // Сообщения\n   //\tprevSlideMessage: 'Previous slide',\n   //\tnextSlideMessage: 'Next slide',\n   //\tfirstSlideMessage: 'This is the first slide',\n   //\tlastSlideMessage: 'This is the last slide',\n   //\tpaginationBulletMessage: 'Go to slide {{index}}',\n   //\tnotificationClass: 'swiper-notification',\n   //\tcontainerMessage: '',\n   //\tcontainerRoleDescriptionMessage: '',\n   //\titemRoleDescriptionMessage: '',\n   // и т.д.\n   //},\n});\nlet myGallerySlider = new Swiper(\".gallery-swiper\", {\n  navigation: {\n    nextEl: \".swiper-button-next\",\n    prevEl: \".swiper-button-prev\",\n  },\n  pagination: {\n    el: \".swiper-pagination\",\n    //clickable: true,\n    //dynamicBullets: true,\n    //renderBullet: function (index, className) {\n    //   return '<span class=\"' + className + '\">' + (index + 1) + \"</span>\";\n    //},\n    type: \"fraction\",\n    //type: \"progressbar\",\n  },\n  //Отвечает за свайпы\n  simulateTouch: true,\n  //Отвечает за чуствительность свайпа (с какой силой нужно перетаскивать)\n  touchRatio: 1,\n  //Угол свайпа\n  touchAngel: 45,\n  //Курсор перетаскивания\n  grabCursor: true,\n  //Переключение при клике на слайд\n  slideToClickSlide: true,\n\n  //Навигация по хешу\n  hashNavigation: {\n    watchState: true,\n  },\n\n  //Управление клавиатурой\n  keyboard: {\n    //Включить/выключить\n    enabled: true,\n    //Только когда слайдер виден\n    onlyInViewport: true,\n    //Разрешние для pageUp, pageDown\n    pageUpDown: true,\n  },\n\n  //Управление колесом мыши\n  //  mousewheel: {\n  //Чуствитиленомть мышки\n  // sensitivity: 1,\n  //Класс объекта на котором будет срабатывать\n  // eventsTarget: \".image-slider\",\n  //  },\n\n  autoHeight: false,\n\n  //Количество слайдов для показа(можно указывать не только целые числа)\n  //Если указать 'auto', то количество будет выбираться автоматически (лучше также указывать width:auto)\n  slidesPerView: 3,\n\n  //Отключает слайдер если слайдов меньше чем нужно\n  watchOverflow: true,\n\n  //Отступ между слайдами\n  //spaceBetween: -400,\n\n  //Количество пролистываемых слайдов\n  slidesPerGroup: 1,\n\n  //Активный слайд по центру\n  //centerSlides: true,\n\n  //Стартовый слайд (первый это нулевой)\n  initialSlide: 0,\n\n  //Мультиряды\n  //slidesPerColumn: 2,\n\n  //Бесконечный слайдер\n  // loop: true,\n\n  //Количество дублирующих слайдов\n  //loopSlides: 1,\n\n  //Свободный режим (прокрутка на любое место)\n  freeMode: true,\n\n  //Автопрокрутка\n  //autoplay: {\n  //   //Пауза между прокрутами\n  //   delay: 1000,\n  //   //Закончить на последнем слайде\n  //stopOnLastSlide: false,\n  //   //Отключение после ручной прокрутки\n  //   disableOnInteraction: false,\n  //},\n\n  //Скорость прокрутки слайдов\n  speed: 400,\n\n  //Вертикальный слайдер\n  //direction: \"vertical\",\n\n  //Эффекты переключения слайдов\n  //Листание\n  effect: \"slide\",\n  //Смена прозрачности\n  //effect: \"fade\",\n\n  //// Дополнения к fade\n  //fadeEffect: {\n  //   //Паралельная смена прозрачности\n  //   crossFade: true,\n  //},\n\n  //Переворот\n  //effect: \"flip\",\n\n  //flipEffect: {\n  //   //Тень\n  //   slideShadows: true,\n  //   //Показ только активного слайда\n  //   limitRotation: true,\n  //},\n\n  //Кубик\n  //effect: \"cube\",\n\n  //cubeEffects: {\n  //   slideShadows: true,\n  //   shadow: true,\n  //   shadowOffset: 20,\n  //   shadowScale: 0.94,\n  //},\n\n  //Поток\n  //effect: \"coverflow\",\n\n  //coverflowEffect: {\n  //   //Угол\n  //   rotate: 20,\n  //   //Наложение\n  //   stretch: 50,\n  //   //Тень\n  //   slideShadows: true,\n  //},\n  //Брейкпоинты\n  //Есть возможность указывать и соотненшение сторон вместо ьрейкпоинтов в виде \"@0.75\"\n  breakpoints: {\n    320: {\n       slidesPerView: 1,\n    },\n    767: {\n       slidesPerView: 2,\n    },\n    1183: {\n       slidesPerView: 3,\n    },\n  },\n\n  //Lazy loading\n  //\n  //preloadImages: false,\n\n  //lazy: {\n  //   //Подгрузка на старте\n  //   loadTransitionStart: false,\n  //   //Подгрузка предыдущей и следующей картинки\n  //   loadPrevNext: false,\n  //},\n  ////--------------------------------\n  ////Стоит включать если показ более одного слайда\n  ////Слежка за видимыми слайдами\n  //watchSlidesProgress: true,\n  ////Добавления класса видимыми слайдами\n  //WatchSlidesVisibility: true,\n\n  //  zoom: {\n  //Максимальное и минимальное увеличение\n  //     maxRatio: 5,\n  //     minRatio: 1,\n  //  },\n\n  //Мини-слайдер\n  //  thumbs: {\n  //     swiper: {\n  //        el: \".image-mini-slider\",\n  //        slidesPerView: 4,\n  //     },\n  //  },\n\n  // Обновить свайпер\n  // при изменении элементов слайдера\n  observer: true,\n\n  // Обновить свайпер\n  // при изменении родительских\n  // элементов слайдера\n  observeParents: true,\n\n  // Обновить свайпер\n  // при изменении дочерних\n  // элементов слайда\n  observeSlideChildren: true,\n\n  //Виртуальные слайды\n  //virtual: {\n  //\tslides: (function () {\n  //\t\tlet slide = []\n  //\t\tfor (let i = 0; i < 500; i++) {\n  //\t\t\tslide.push(`<div class=\"image-slider__text\">Слайд №${i}</div>`);\n  //\t\t}\n  //\t\treturn slide;\n  //\t}()),\n  //},\n\n  // Доступность\n  //a11y: {\n  // Включить/выключить\n  //\tenabled: true,\n  // Сообщения\n  //\tprevSlideMessage: 'Previous slide',\n  //\tnextSlideMessage: 'Next slide',\n  //\tfirstSlideMessage: 'This is the first slide',\n  //\tlastSlideMessage: 'This is the last slide',\n  //\tpaginationBulletMessage: 'Go to slide {{index}}',\n  //\tnotificationClass: 'swiper-notification',\n  //\tcontainerMessage: '',\n  //\tcontainerRoleDescriptionMessage: '',\n  //\titemRoleDescriptionMessage: '',\n  // и т.д.\n  //},\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/libs/swiper.js?");
